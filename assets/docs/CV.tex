...
\section{Granted Patents}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \small{\item{
    {CHEN Xiang, \textbf{FAN Xiao}, } {\textbf{In-car Mixed Reality Display Method \& Equipment}, }
    {Application No.: CN202011089648.2}
    }}
    \small{\item{
    {CHEN Xiang, \textbf{FAN Xiao}, } {\textbf{Automated Driving Model Sampling, Training Method, Equipment \& System}, }
    {Application No.: CN20201129255.X}
    }}
 \end{itemize}
